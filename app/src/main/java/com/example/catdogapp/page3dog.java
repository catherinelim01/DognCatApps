...
public class page3dog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnGenerator.setOnClickListener(v -> {
            Intent intent = new Intent(page3dog.this, page2dog.class);
            startActivity(intent);
        });

        BtnHome2.setOnClickListener(v -> {
            Intent intent = new Intent(page3dog.this, MainActivity.class);
            startActivity(intent);
        });

        ImageView dogImage = (ImageView) findViewById(R.id.triviaImage);
    ...
    public void nextButton() {
        ...
        try {
            JSONArray Array = obj.getJSONArray("dog");
